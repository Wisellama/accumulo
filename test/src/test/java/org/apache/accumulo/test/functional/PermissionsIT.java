...
public class PermissionsIT extends SimpleMacIT {
  ...
  private static void testMissingSystemPermission(Connector root_conn, Connector test_user_conn, SystemPermission perm) throws AccumuloException,
      TableExistsException, AccumuloSecurityException, TableNotFoundException, TableNamespaceExistsException, TableNamespaceNotFoundException, TableNamespaceNotEmptyException {
  ...
  private static void testGrantedSystemPermission(Connector root_conn, Connector test_user_conn, SystemPermission perm) throws AccumuloException,
      AccumuloSecurityException, TableNotFoundException, TableExistsException, TableNamespaceExistsException, TableNamespaceNotFoundException, TableNamespaceNotEmptyException {
    String tableName, user, password = "password", tableNamespace;
