...
public class ClientServiceHandler implements ClientService.Iface {
  ...
  @Override
  public boolean checkTableNamespaceClass(TInfo tinfo, TCredentials credentials, String tableNamespace, String className, String interfaceMatch) throws TException,
      ThriftTableOperationException, ThriftSecurityException {
